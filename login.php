      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-lg-4 text-right">
            ...
            <a href="login.php" class="small btn btn-primary px-4 py-2 rounded-0 active"><span class="icon-key"></span> Log In</a>
          </div>
        </div>
      </div>
    </div>
...
<form action="codes/alcode.php" method="post">
            <div class="row justify-content-center">
			
                <div class="col-md-5">
                    <div class="row">
					<div class="col-md-12 form-group">
   <select name="users" id="cars" class="form-control form-control-lg">
