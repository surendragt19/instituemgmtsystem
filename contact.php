...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <div class="site-wrap">
    ...
    <div class="site-section">
        <div class="container">
		<form action="codes/contactcode.php" method="post" id="contact-form">
            <div class="row">
            ...
            <div class="row">
			<div class="col-md-6 form-group">
                    <label for="tel">College Name</label>
                    <input type="text" required name="clg_name" class="form-control form-control-lg">
                </div>
                <div class="col-md-6 form-group">
			...
			<div class="col-md-6 form-group">
                    ...
                    <input type="text" required name="add" class="form-control form-control-lg">
                </div>
                <div class="col-md-6 form-group">
                    <label for="eaddress">Contact Number</label>
                    <input type="number" required name="mob" class="form-control form-control-lg">
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 form-group">
                    <label for="message">Message</label>
                    <textarea name="msg" required cols="30" rows="5" class="form-control"></textarea>
                </div>
            </div>
...
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3558.563890570036!2d80.95719511499735!3d26.885593583139343!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x399957d8b7c0a8e5%3A0x3e13a459b34665ca!2sHewett%20Polytechnic!5e0!3m2!1sen!2sin!4v1613914120733!5m2!1sen!2sin" width="100%" height="350" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
</div>
<!--//location-->
<!--comman-->
